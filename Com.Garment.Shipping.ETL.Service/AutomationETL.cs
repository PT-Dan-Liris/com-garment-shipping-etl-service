...
namespace Com.Garment.Shipping.ETL.Service
{
    public class AutomationETL
    {
        ...
        public async Task AutomationETLBatch1([TimerTrigger("0 0 0 5 * *")]TimerInfo myTimer, ILogger log)
        {
        ...
        public async Task AutomationETLBatch2([TimerTrigger("0 0 0 5 * *")] TimerInfo myTimer, ILogger log)
        {
            log.LogInformation($"C# Timer trigger function executed at: {DateTime.Now}");
